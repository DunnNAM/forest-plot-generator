...
| **Status** | **Partially resolved — CHG-055 (sub-issues 2 and 3). Sub-issue 1 (Help page title alignment) was not touched and remains open — that work was entirely on the navbar tabs/brand, not `R/ui_help.R`.** |
